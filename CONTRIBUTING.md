# Contributing to Testee

## Developing Locally

This section will walk you through setting up the [repository](https://github.com/bitovi/testee) on your computer.
...
GitHub has a guide for [forking a repo](https://help.github.com/articles/fork-a-repo/). To fork testee, you can start by going to its [fork page](https://github.com/bitovi/testee/fork).
